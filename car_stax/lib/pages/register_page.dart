                                              ...
                                              child: AnimatedSize(
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    Text("Join Company",style: TextStyle(fontSize: screenWidth/14),),
                                                    SizedBox(height: 5),
                                                  ],
                                                ),
                                              ),
                                              ...
                                              child: AnimatedSize(
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    Expanded(child: Text("Create Company", style: TextStyle(fontSize: screenWidth/14),textAlign: TextAlign.center,)),
                                                    SizedBox(height: 5),
                                                  ],
                                                ),
                                              ),
